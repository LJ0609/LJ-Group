...
class GCNnet_volleyball(nn.Module):
    ...
    def forward(self,batch_data):
        ...
        # boxes_features2=boxes_features.reshape(B*T*N,-1)#===================================================
        # print('boxes_features2',boxes_features2.shape)
        # boxes_features_tr = self.bbox_fc(boxes_features2).reshape(B, T, N, -1)
...
#         boxes_states= torch.cat( [graph_boxes_features,boxes_features],dim=3)  #B, T, N, NFG+NFB
        ...
        # global_token=boxes_states_pooled.reshape(-1,B*T,NFS)#===============================
        # global_token=self.globall(global_token)
