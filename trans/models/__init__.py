...
from trans.utils.utils import load_model, load_DDPModel
from trans.utils.log_helper import init_log

from trans.utils.pos_encoding import spatialencoding2d
...
class ModelBuilder(nn.Module):
    def __init__(self, config):
        ...
        self.backbone = BackboneBuilder(config.structure.backbone) #inv3_version2
        self.backbone2=BackboneBuilder(config.structure.flow_backbone) #i3d_flow_acy
