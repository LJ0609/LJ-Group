...
class Config(object):
    ...
    def __init__(self, dataset_name):
        ...
        self.stage1_model_path='/media/ssd2/liuj/CV/DIN-Group-Activity-Recognition-Benchmark-main/result/[Volleyball_stage1_stage1]<2022-04-24_11-45-17>/stage1_epoch65_92.52%25.pth'  #path of the base model, need to be set in stage2
        self.pose_head_path=''
